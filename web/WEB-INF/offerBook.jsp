...
<c:url value="ControllerMain?section=bookGeneral" var="url131" />
                ...
                <c:choose>
                    ...
                    <c:when test="${p.getDiscount()==null}">
                        <div class="elementCatalog">   
                            <a class="blocCatalog" href="${url131}&booId=${p.getBookIsbn()}"> <img src="${p.getImageURL()}" alt="cover"/> </a>
                        </div>
                    ...
                    <c:when test="${p.getDiscount()!=null}"> 
                        <div class="elementCatalog">   
                            <a class="blocCatalog" href="${url131}&booId=${p.getBookIsbn()}"> 
                     ...
                     <c:choose>
                            ...
                            <c:when test="${p.getBooQuantity()<1}">
                                <div class="boutonOrder"><a href="#" class=" zocial cart">Indisponible</a></div>   
                            </c:when>

                            <c:when test="${p.getBooQuantity()>=1}">

                                <div class="boutonOrder"><a href="ControllerMain?item=${p.bookIsbn}&action=add&section=${currentSection}&offid=${offid}" class=" zocial cart">Commander</a></div>   
