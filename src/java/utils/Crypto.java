...
public class Crypto {
    ...
    public static String verifyPassword(String salt, String hashedPassword) throws NoSuchAlgorithmException, Exception {
     ...
     */
    public static String[] createPassword(String password) throws NoSuchAlgorithmException, Exception {
